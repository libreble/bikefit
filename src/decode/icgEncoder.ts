...
/**
 * Build a `SET_ALL_USER_DATA` (msg 2) frame (PROTOCOL.md §8a): a fixed 10-byte, big-endian
 * payload framed by {@link encodeIcgFrame}, byte-for-byte what the bike expects.
 */
