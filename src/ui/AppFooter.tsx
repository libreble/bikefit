...
const REPO = 'https://github.com/libreble/bikefit'
  ...
  return (
    <footer className="app-footer">
      <p className="app-footer__links">
        <a href="https://libreble.github.io/" className="app-footer__link">
          <LibrebleMark />
          {t('footer.partOf')}{' '}
          <span className="app-footer__brand">
            libre<span className="app-footer__ble">ble</span>
          </span>
        </a>
        <a href={REPO} target="_blank" rel="noopener noreferrer" className="app-footer__link">
          <GitHubMark />
          {t('footer.github')}
        </a>
        <a
        ...
        {RELEASE ? (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="app-footer__link app-footer__version"
          >
            {__APP_VERSION__}
          </a>
        ) : (
...
function LibrebleMark() {
  return (
    <svg viewBox="0 0 64 64" className="app-footer__icon" aria-hidden>
      <g
...
function GitHubMark() {
  return (
    <svg viewBox="0 0 16 16" fill="currentColor" className="app-footer__icon" aria-hidden>
